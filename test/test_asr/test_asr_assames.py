...
AUDIO_SAMPLE = Path(__file__).resolve().parent/"asr_samples"/"test_asr_assames.wav"
...
REFERENCE = "তাৰিখ আৰু সময় স্বাক্ষৰ কৰক ঠিকনাসমূহ এই পৰিচয়ত লিখিব নোৱাৰি ."
...
def test_asr(api_client, base_url, auth_token_refreshed, setup_logger):
    ...
    payload = asr_payload(
        ...
        sourceLanguage="as",               # Hindi ISO code
        sourceScriptCode="Beng",          # Devanagari script code
        samplingRate=16000,
        encoding="base64",
