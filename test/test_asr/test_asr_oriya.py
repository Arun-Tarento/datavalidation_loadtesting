...
AUDIO_SAMPLE = Path(__file__).resolve().parent/"asr_samples"/"test_asr_oriya.wav"
...
REFERENCE = "ବାହା ହେବା ଦିନଠାରୁ ଅପରାଜିତାଙ୍କର ଏହି ଅନୁରୋଧକୁ ମୁଁ କିଛି ନା କିଛି ଯୁକ୍ତି ଦେଖାଇ ଏଡ଼େଇ ଦେଇ ଆସିଛି।"
