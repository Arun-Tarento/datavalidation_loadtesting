...
AUDIO_SAMPLE = Path(__file__).resolve().parent/"asr_samples"/"malayalam_test_sample.wav"
...
REFERENCE = "നിലവാരമുള്ളതായി രാജ്യത്ത് ആറ് സ്ഥാപനങ്ങള് മാത്രമേ കണ്ടെത്താന് കഴിഞ്ഞുള്ളൂ എന്ന വിലയിരുത്തലില് കമ്മിറ്റി ഉറച്ചു നിന്നു"
