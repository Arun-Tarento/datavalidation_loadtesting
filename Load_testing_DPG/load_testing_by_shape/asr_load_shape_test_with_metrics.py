"""
ASR Load Shaping Test with Enhanced Metrics - Find Server Capacity

This script gradually increases load and captures detailed per-stage metrics.

Usage:
    locust -f load_testing_scripts/asr_load_shape_test_enhanced.py --host=http://13.204.164.186:8000
...
from shape_config import ASRUser, ASRConfig
...
def on_test_stop(environment, **kwargs):
    ...
    print("\n" + "="*70)
    print("📊 ASR LOAD SHAPE TEST COMPLETED")
    print("="*70)
...
def save_enhanced_results(output: Dict[str, Any]):
    ...
    filename = os.path.join(results_dir, f"asr_load_shape_results_{timestamp}.json")
...
if __name__ == "__main__":
    print("\n" + "="*70)
    print("ASR Load Shape Testing with Enhanced Metrics")
    print("="*70)
    ...
    print("\nTo run this test:")
    print("  locust -f Load_testing_DPG/load_testing_by_shape/asr_load_shape_test_with_metrics.py --host=http://13.204.164.186:8000")
    print("\nResults will be saved to:")
    print("  Load_testing_DPG/load_testing_shape_results/asr_load_shape_results_TIMESTAMP.json")
    print("="*70 + "\n")
