"""
ASR Progressive Load Testing with Enhanced Metrics - AI4I Core API

This script gradually increases load and captures detailed per-stage metrics.

Usage:
    locust -f Load_tesing_AI4I_Core/Load_testing_progressive/asr_load_testing_progressive.py
...
def on_test_stop(environment, **kwargs):
    ...
    print("\n" + "="*70)
    print("📊 ASR PROGRESSIVE LOAD TEST COMPLETED - AI4I Core API")
    print("="*70)
...
def build_enhanced_json_output(environment, stage_metrics: Dict) -> Dict[str, Any]:
    ...
    overall_stats = {
        "test_info": {
            ...
            "service": "ASR (Speech Recognition) - AI4I Core API",
            "api_endpoint": "/api/v1/asr/inference",
...
def save_enhanced_results(output: Dict[str, Any]):
    ...
    filename = os.path.join(results_dir, f"asr_progressive_results_{timestamp}.json")
...
if __name__ == "__main__":
    print("\n" + "="*70)
    print("ASR Progressive Load Testing with Enhanced Metrics - AI4I Core API")
    print("="*70)
