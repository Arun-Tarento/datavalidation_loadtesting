...
class ASRConfig:
    ...
    def _load_audio_samples(self) -> List[str]:
        ...
        audio_file_path = os.getenv("AUDIO_SAMPLES_FILE", "load_testing_test_samples/asr/audio_samples.json.example")
...
def save_results_to_json(environment):
    ...
    filename = "load_testing_results/asr_latency_locust_results.json"
